package org.smartregister.chw.fp_sample.repository;
...
import org.smartregister.chw.fp_sample.BuildConfig;
import org.smartregister.chw.fp.FpLibrary;
import org.smartregister.chw.fp_sample.application.SampleApplication;
...
public class SampleRepository extends Repository {
    ...
    public void onCreate(SQLiteDatabase database) {
        ...
        FpLibrary.getInstance().visitRepository().createTable(database);
        FpLibrary.getInstance().visitDetailsRepository().createTable(database);
