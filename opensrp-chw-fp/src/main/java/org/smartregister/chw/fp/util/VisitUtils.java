...
import org.smartregister.chw.fp.repository.VisitDetailsRepository;
...
public class VisitUtils {
    ...
    public static List<Visit> getVisitsOnly(String memberID, String visitName) {
        return new ArrayList<>(FpLibrary.getInstance().visitRepository().getVisits(memberID, visitName));
    }

    public static List<VisitDetail> getVisitDetailsOnly(String visitID) {
        return FpLibrary.getInstance().visitDetailsRepository().getVisits(visitID);
    }
    ...
    public static void processVisits(String baseEntityID) throws Exception {
        processVisits(FpLibrary.getInstance().visitRepository(), FpLibrary.getInstance().visitDetailsRepository(), baseEntityID);
    }
    ...
    public static void deleteProcessedVisit(String visitID, String baseEntityId) {
        // check if the event
        AllSharedPreferences allSharedPreferences = FpLibrary.getInstance().context().allSharedPreferences();
        Visit visit = FpLibrary.getInstance().visitRepository().getVisitByVisitId(visitID);
