 ...
 */
public class FpCbdFollowupProvisionOfHealthEducationActionHelper extends FpVisitActionHelper {
    protected Context context;

    protected FpMemberObject fpMemberObject;

    protected String fpEducationProvided;

    public FpCbdFollowupProvisionOfHealthEducationActionHelper(Context context, FpMemberObject fpMemberObject) {
    ...
    public void onPayloadReceived(String jsonPayload) {
        try {
            ...
            fpEducationProvided = JsonFormUtils.getValue(jsonObject, "family_planning_education_provided");
        } catch (Exception e) {
            Timber.e(e);
        }
    }
    ...
    public BaseFpVisitAction.Status evaluateStatusOnPayload() {
        if (StringUtils.isNotBlank(fpEducationProvided)) {
