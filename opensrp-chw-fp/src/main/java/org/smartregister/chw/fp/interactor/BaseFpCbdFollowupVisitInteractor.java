...
public class BaseFpCbdFollowupVisitInteractor implements BaseFpVisitContract.Interactor {
    ...
    @VisibleForTesting
    public BaseFpCbdFollowupVisitInteractor(AppExecutors appExecutors, FpLibrary FpLibrary, ECSyncHelper syncHelper) {
    ...
    public BaseFpCbdFollowupVisitInteractor() {
    ...
    public void calculateActions(final BaseFpVisitContract.View view, FpMemberObject fpMemberObject, final BaseFpVisitContract.InteractorCallBack callBack) {
        ...
        final Runnable runnable = () -> {
            try {
                evaluateHealthEducation(fpMemberObject, details);
                evaluateSatisfactionOfFpMethod(fpMemberObject, details, callBack);
                evaluateNextAppointmentDate(fpMemberObject, details);
    ...
    protected void evaluateHealthEducation(FpMemberObject fpMemberObject, Map<String, List<VisitDetail>> details) throws BaseFpVisitAction.ValidationException {
        FpVisitActionHelper actionHelper = new FpCbdFollowupProvisionOfHealthEducationActionHelper(mContext, fpMemberObject);
        String actionName = mContext.getString(R.string.fp_health_education);
        BaseFpVisitAction action = getBuilder(actionName).withOptional(false).withProcessingMode(BaseFpVisitAction.ProcessingMode.SEPARATE).withDetails(details).withHelper(actionHelper).withFormName(FamilyPlanningConstants.FORMS.FP_CBD_FOLLOWUP_HEALTH_EDUCATION).build();
    ...
    protected void evaluateSatisfactionOfFpMethod(FpMemberObject fpMemberObject, Map<String, List<VisitDetail>> details, final BaseFpVisitContract.InteractorCallBack callBack) throws BaseFpVisitAction.ValidationException {
        FpVisitActionHelper actionHelper = new FpCbdFollowupMethodSatisfactionActionHelper(mContext, fpMemberObject, details, actionList, callBack);
        String actionName = mContext.getString(R.string.fp_method_satisfaction);
        BaseFpVisitAction action = getBuilder(actionName).withOptional(false).withDetails(details).withHelper(actionHelper).withFormName(FamilyPlanningConstants.FORMS.FP_CBD_FOLLOWUP_METHOD_SATISFACTION).build();
        actionList.put(actionName, action);
    }
