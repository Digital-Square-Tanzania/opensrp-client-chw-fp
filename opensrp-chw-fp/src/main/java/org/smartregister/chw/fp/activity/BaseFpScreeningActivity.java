...
public class BaseFpScreeningActivity extends SecuredActivity implements BaseFpVisitContract.View, View.OnClickListener {

    private static final String TAG = BaseFpScreeningActivity.class.getCanonicalName();
    ...
    public static void startMe(Activity activity, String baseEntityID, Boolean isEditMode) {
        Intent intent = new Intent(activity, BaseFpScreeningActivity.class);
    ...
    protected void registerPresenter() {
        presenter = new BaseFpVisitPresenter(fpMemberObject, this, new BaseFpScreeningVisitInteractor());
    }
    ...
    public void redrawHeader(FpMemberObject fpMemberObject) {
        tvTitle.setText(MessageFormat.format("{0}, {1} \u00B7 {2}", fpMemberObject.getFullName(), String.valueOf(fpMemberObject.getAge()), getString(R.string.fp_screening)));
    }
    ...
    public void onBackPressed() {
        displayExitDialog(BaseFpScreeningActivity.this::finish);
    }
