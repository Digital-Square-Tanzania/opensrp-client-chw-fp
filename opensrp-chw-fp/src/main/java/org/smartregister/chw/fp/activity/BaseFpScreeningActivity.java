...
public class BaseFpScreeningActivity extends SecuredActivity implements BaseFpVisitContract.View, View.OnClickListener {
    ...
    protected void registerPresenter() {
        presenter = new BaseFpVisitPresenter(memberObject, this, new BaseFpScreeningVisitInteractor());
    }
    ...
    public void redrawHeader(MemberObject memberObject) {
        tvTitle.setText(MessageFormat.format("{0}, {1} \u00B7 {2}", memberObject.getFullName(), String.valueOf(memberObject.getAge()), getString(R.string.fp_screening)));
    }
