package org.smartregister.chw.fp_sample.model;
...
public class BaseFpRegisterFragmentModelTest {

    @Mock
    private BaseFpRegisterFragmentModel baseTestRegisterFragmentModel;
